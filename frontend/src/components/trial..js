...
function Navbar() {
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer">ClassyBook</a>
  </div>
...
i want search bar to work, I have database in mongodb where I have saved the data
...
Tell me how can I make search funcatioanlity in navbar work